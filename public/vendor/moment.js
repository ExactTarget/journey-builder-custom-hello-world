...
(function (undefined) {
    ...
    ************************************/
    ...
    var moment,
        ...
        // timezone chunker "+10:00" > ["10", "00"] or "-1530" >
        // ["-15", "30"]
    ...
    ************************************/
    ...
    function Duration(duration) {
        ...
        // Because of dateAddRemove treats 24 hours as different from
        // a
    ...
    ************************************/
    ...
    // Loads a language definition into the `languages` cache.  The
    // function
    // takes a key and optionally values.  If not in the browser and
    // no values
    // are provided, it will load the language file module.  As a
    // convenience,
    ...
    // Remove a language from the `languages` cache. Mostly useful in
    // tests.
    ...
    // definition for 'en', so long as 'en' has already been loaded
    // using
    // moment.lang.
    function getLangDefinition(key) {
        ...
        //through the list trying each
        //substring from most specific to least, but move to the next
        //array item if it's a more specific variant than the current
        //root
        while (i < key.length) {
    ...
    function dateFromConfig(config) {
        ...
        if (config._w && config._a[DATE] == null && config._a[MONTH] == null) {
            ...
            if (w.GG != null || w.W != null || w.E != null) {
                ...
                //if we're parsing 'd', then the low day numbers may
                //be next week
        ...
        // add the offsets to the time to be parsed so that we can
        // have a clean array for checking isValid
    ...
    ************************************/
    ...
    // This function will load languages and then set the global
    // language.  If
    ...
    ************************************/
    ...
    extend(moment.fn = Moment.prototype, {
        ...
        subtract : function (input, val) {
            var dur;
            // switch args to support subtract('s', 1) and subtract(1,
            // 's')
            if (typeof input === 'string') {
                dur = moment.duration(+val, input);
            } else {
        ...
        calendar : function () {
            ...
            // Getting start-of-today depends on whether we're zone'd
            // or not.
        ...
        // instance.  Otherwise, it will return the language
        // configuration
    ...
    // loop through and add shortcuts (Month, Date, Hours, Minutes,
    // Seconds, Milliseconds)
    for (i = 0; i < proxyGettersAndSetters.length; i ++) {
        makeGetterAndSetter(proxyGettersAndSetters[i].toLowerCase().replace(/s$/, ''), proxyGettersAndSetters[i]);
    }

    // add shortcut for year (uses different syntax than the
    // getter/setter 'year' == 'FullYear')
    ...
    ************************************/
    ...
    // Set default language, other languages will inherit from
    // English.
    moment.lang('en', {
        ordinal : function (number) {
            var b = number % 10,
...
(function (factory) {
    ...
    return moment.lang('cs', {
        ...
        monthsParse : (function (months, monthsShort) {
            var i, _monthsParse = [];
            for (i = 0; i < 12; i++) {
                // use custom parser to solve problem with July
                // (Äervenec)
...
(function (factory) {
    ...
    return moment.lang("cy", {
        ...
        // traditional ordinal numbers above 31 are not commonly used
        // in colloquial Welsh
        ordinal: function (number) {
            var b = number,
                output = '',
...
// traduko.
//          Se ne, bonvolu korekti kaj avizi min por ke mi povas
//          lerni!
...
(function (factory) {
    ...
    return moment.lang('hi', {
        ...
        // Hindi notation for meridiems are quite fuzzy in practice.
        // While there exists
...
// author : Hinrik Ã–rn SigurÃ°sson :
...
// Note: Luxembourgish has a very particular phonological rule
// ("Eifeler Regel") that causes the
// deletion of the final "n" in certain contexts. That's what the
// "eifelerRegelAppliesToWeekday"
...
(function (factory) {
    ...
    /**
     * Returns true if the word before the given week day loses the
     * "-n" ending.
    ...
    /**
     * Returns true if the word before the given number loses the "-n"
     * ending.
    ...
    function eifelerRegelAppliesToNumber(number) {
        ...
        if (number < 0) {
            ...
            // Anything larger than 4 digits: recursively check first
            // n-3 digits
            number = number / 1000;
            return eifelerRegelAppliesToNumber(number);
        }
...
(function (factory) {
    ...
    return moment.lang('ru', {
        ...
        // M. E.: those two are virtually unused but a user might want
        // to implement them for his/her website for some reason
...
(function (factory) {
    ...
    return moment.lang('zh-cn', {
        ...
        week : {
            // GB/T
            // 7408-1994ã€Šæ•°æ®å…ƒå’Œäº¤æ¢æ
            // ¼å¼Â·ä¿¡æ¯äº¤æ¢Â·æ—¥æœŸå’Œæ—¶é—´è¡¨ç¤ºæ³•ã€‹ä¸ŽISO
            // 8601:1988ç­‰æ•ˆ
            dow : 1, // Monday is the first day of the week.
            doy : 4  // The week that contains Jan 4th is the first week of the year.
        }
...
(function (factory) {
    ...
    ************************************/
    ...
    function makeGlobal(deprecate) {
        ...
        // here, `this` means `window` in the browser, or `global` on
        // the server
